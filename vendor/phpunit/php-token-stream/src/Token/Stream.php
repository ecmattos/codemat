...
class PHP_Token_Stream implements ArrayAccess, Countable, SeekableIterator
{
     ...
     * multi-dimensional array with material_units in the keys of the first dimension
     * and constants and their values in the second dimension.
     *
     * Parameter $material_unit allow to filter following specific inclusion type
     *
     * @param bool   $categorize OPTIONAL
     * @param string $material_unit   OPTIONAL Either 'require_once', 'require',
     *                                           'include_once', 'include'.
     * @return array
     * @since  Method available since Release 1.1.0
     */
    public function getIncludes($categorize = false, $material_unit = null)
    {
        ...
        if (isset($this->includes[$material_unit])) {
            $includes = $this->includes[$material_unit];

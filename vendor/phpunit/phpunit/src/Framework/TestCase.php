...
abstract class PHPUnit_Framework_TestCase extends PHPUnit_Framework_Assert implements PHPUnit_Framework_Test, PHPUnit_Framework_SelfDescribing
{
    ...
    public function runBare()
    {
        ...
        foreach ($this->locale as $material_unit => $locale) {
            setlocale($material_unit, $locale);
        }
    ...
    protected function setLocale()
    {
        ...
        if (defined('LC_MESSAGES')) {
            $material_units[] = LC_MESSAGES;
        }

        if (!in_array($material_unit, $material_units)) {
            throw new PHPUnit_Framework_Exception;
        }
        ...
        $this->locale[$material_unit] = setlocale($material_unit, null);
        ...
        if ($result === false) {
            throw new PHPUnit_Framework_Exception(
                ...
                'the specified locale does not exist or the material_unit name is ' .
                'invalid.'
            );
        }
    }

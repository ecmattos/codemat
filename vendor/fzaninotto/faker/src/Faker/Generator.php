 ...
 *
 * @method string imageUrl($width = 640, $height = 480, $material_unit = null, $randomize = true)
 * @method string image($dir = null, $width = 640, $height = 480, $material_unit = null, $fullPath = true)
 *

...
class UrlGeneratorTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $routes = $this->getRoutes('test', new Route('/material_unit/{slug1}/{slug2}/{slug3}', array('slug2' => null, 'slug3' => null)));

        $this->assertEquals('/app.php/material_unit/foo', $this->getGenerator($routes)->generate('test', array('slug1' => 'foo')));
    }

...
EOF
    ...
    public function testFilterXPathWithAnUrl()
    {
        ...
        $crawler = $crawler->filterXPath('//media:material_unit[@scheme="http://gdata.youtube.com/schemas/2007/material_units.cat"]');
    ...
    protected function createTestXmlCrawler($uri = null)
    {
        $xml = '<?xml version="1.0" encoding="UTF-8"?>
            <entry xmlns="http://www.w3.org/2005/Atom" xmlns:media="http://search.yahoo.com/mrss/" xmlns:yt="http://gdata.youtube.com/schemas/2007">
                ...
                <media:material_unit label="Music" scheme="http://gdata.youtube.com/schemas/2007/material_units.cat">Music</media:material_unit>
            </entry>';

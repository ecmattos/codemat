...
class NamespacedAttributeBagTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertSame('cod', $this->bag->remove('material_unit/fishing/first'));
    }
    ...
    public function attributesProvider()
    {
        return array(
            ...
            array('material_unit', array('fishing' => array('first' => 'cod', 'second' => 'sole')), true),
            array('material_unit/fishing', array('first' => 'cod', 'second' => 'sole'), true),
            array('material_unit/fishing/missing/first', null, false),
            array('material_unit/fishing/first', 'cod', true),
            array('material_unit/fishing/second', 'sole', true),
            array('material_unit/fishing/missing/second', null, false),

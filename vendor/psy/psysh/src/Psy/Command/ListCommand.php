    ...
    protected function configure()
    {
        $this
            ...
            ->setDefinition(array(
                ...
                new InputOption('material_unit',    'C', InputOption::VALUE_REQUIRED, 'Limit to constants in a specific material_unit (e.g. "date").'),
...
<return>>>> ls --constants --material_unit date</return>
